...
const BentoCardGrid = ({ children, gridRef, className = '', style }) => (
  <div className={`bento-section ${className}`} style={style} ref={gridRef}>
    {children}
  </div>
);
...
const MagicBento = ({
  ...
  return (
    <>
      ...
      {children ? (
        <BentoCardGrid gridRef={gridRef} className="relative w-full">
          {children}
        </BentoCardGrid>
      ) : (
        <BentoCardGrid
          gridRef={gridRef}
          className="grid gap-2 p-3 max-w-[54rem] select-none relative"
